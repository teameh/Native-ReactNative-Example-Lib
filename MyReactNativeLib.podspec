...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Tieme van Veen/MyReactNativeLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tieme van Veen' => 'tieme.van.veen@persgroep.net' }
  s.source           = { :git => 'https://github.com/Tieme van Veen/MyReactNativeLib.git', :tag => s.version.to_s }
